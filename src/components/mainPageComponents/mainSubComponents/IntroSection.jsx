...
const IntroSection = () => {
    return (
        <div className=' lg:w-[1050px] md:w-full sm:w-full h-full flex gap-7 justify-between border-b-2 border-[#B0B3B3] dark:border-[#65676B] px-3'>
            <div className="img w-[20%] h-[100px] relative">
                <img src="/pfp.png" alt="" className=' w-[170px] h-[170px] rounded-full absolute -top-20 border bg-white' />
            </div>
            ...
            <div className=' buttons w-[40%] flex items-end pb-10 gap-7 justify-end'>
